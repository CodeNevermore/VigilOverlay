...
class VigilApplication:
    ...
    def _mark_fps_overlay_hidden(self) -> None:
        """Update FPS display policy without pausing background capture or discovery."""

        self._fps_service.set_overlay_visible(False)
        _LOGGER.debug("FPS capture continues while Vigil is hidden")
    ...
    def _show_startup_safety_warning(self) -> None:
        detail = self._startup_safety_warning
        self._startup_safety_warning = None
...
def run_gui(
    ...
    *,
    ...
    retirement: HidHideRetirementOutcome = retire_platform_hidhide_state(
        paths.cache_root,
